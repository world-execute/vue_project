    ...
    <el-row :gutter="10" style="min-width: 1700px">
      ...
      <el-col :span="9" style="">
        ...
        <el-card class="operationWindow">
          <el-tabs style="min-height: 560px" type="border-card" v-model='tabIndex' @tab-click="tabClickHandler">
            <el-tab-pane label="物资申请">
              ...
              <el-card style="margin-top: 30px" v-show="selectMaterial.length === 0">
                <el-alert
                    title="关于添加物资"
                    type="info"
                    :closable="false"
                    description="您可以可以添加物资,点击物资信息表格中操作一栏的加号按钮即可"
                    show-icon>
                </el-alert>
                <img src="../../assets/image/addMaterial.png" style="width: 100%">
              </el-card>
      ...
      <el-col :span="6">
        ...
        <el-card style="padding: 10px">
          ...
          <el-collapse accordion>
            <el-collapse-item>
              ...
              <el-steps :active="getMaterialStepIndex" simple>
                <el-step title="步骤 1" icon="el-icon-edit"></el-step>
                <el-step title="步骤 2" icon="el-icon-s-order"></el-step>
                <el-step title="步骤 3" icon="el-icon-upload"></el-step>
              </el-steps>
              <div style="height: 30px">
                <el-button size="mini" style="float: right;margin-top: 10px" @click="stepNext">
                  下一步
                </el-button>
              </div>

              <template>
                <el-divider content-position="left">(1) 完善个人信息</el-divider>
                <span></span>
              </template>
            ...
            <el-collapse-item>
              <template v-slot:title>
                <svg t="1676517185242" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2903" width="30" height="30"><path d="M992.530132 0H32.023049c-17.689508 0-31.961585 12.735462-31.961584 28.44581v967.10838C0 1011.264538 14.333541 1024 32.023049 1024H992.530132c17.689508 0 32.072221-12.735462 32.072221-28.44581V28.44581C1024.602353 12.735462 1010.21964 0 992.530132 0z m-31.961585 967.108379H64.033806V56.891621h896.48557z" p-id="2904" fill="#409EFF"></path><path d="M219.305642 241.309964h363.980985a97.654934 97.654934 0 0 0 183.594718 0h38.415366a32.57623 32.57623 0 0 0 0-65.152461H766.832173a97.654934 97.654934 0 0 0-183.594718 0h-363.870348a32.57623 32.57623 0 0 0 0 65.152461z m423.183674-32.551645a32.551645 32.551645 0 1 1 32.551644 32.551645 32.551645 32.551645 0 0 1-32.551644-32.551645zM219.305642 534.287059h38.415366a97.654934 97.654934 0 0 0 183.594718 0h363.870348a32.57623 32.57623 0 0 0 0-65.152461H441.315726a97.654934 97.654934 0 0 0-183.594718 0H219.305642a32.57623 32.57623 0 0 0 0 65.152461z m97.654934-32.551645a32.551645 32.551645 0 1 1 32.551645 32.551645 32.551645 32.551645 0 0 1-32.551645-32.551645zM219.305642 827.313325h363.980985a97.654934 97.654934 0 0 0 183.594718 0h38.415366a32.57623 32.57623 0 0 0 0-65.152461H766.832173a97.654934 97.654934 0 0 0-183.545546 0h-363.870348a32.57623 32.57623 0 1 0 0 65.152461z m423.183674-32.551644A32.551645 32.551645 0 1 1 675.04096 827.313325a32.551645 32.551645 0 0 1-32.551644-32.551644z" p-id="2905" fill="#409EFF"></path></svg>
                <span style="margin-left: 10px">
                  如何进行配额申请
                </span>
              </template>
        ...
        <!--用户时间线展示-->
        <el-card style="margin-top: 10px;padding: 10px;min-height: 570px;max-height: 570px;overflow: auto">
          <el-divider>
            <svg t="1676522829913" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8546" width="32" height="32"><path d="M679 337.8c-155.2 0-281.3 127-281.3 283.1C397.7 777 523.9 904 679 904c155.2 0 281.3-127 281.3-283.1 0.1-156-126.2-283.1-281.3-283.1z m0 513.1c-126 0-228.5-103.2-228.5-230s102.5-230 228.5-230 228.5 103.2 228.5 230c0.1 126.8-102.4 230-228.5 230zM99 749.8c-9.3 0-18.1 3.7-24.7 10.3-6.5 6.6-10.2 15.5-10.2 24.7 0 19.4 15.6 35.1 34.8 35.1h268.9c-13.9-22.1-25.5-45.5-34.4-70L99 749.8z m0-559.9h743c19.3 0 34.8-15.7 34.8-35 0-9.3-3.6-18.2-10.1-24.8-6.5-6.6-15.4-10.3-24.7-10.3H99c-18.8 0.8-33.7 16.2-33.7 35 0.1 18.9 14.9 34.4 33.7 35.1z m0 419.9h211.7c0.7-23.5 3.5-47 8.5-70H99c-19.3 0-35 15.7-35 35 0 19.4 15.7 35 35 35z m351.6-279.9H99c-9.3 0-18.2 3.7-24.7 10.3-6.5 6.6-10.2 15.5-10.1 24.8 0 19.4 15.6 35.1 34.8 35.1h284.1c19.5-26.4 42.1-49.9 67.5-70.2z m0 0" p-id="8547" fill="#409EFF"></path><path d="M687.3 616.9v-73.5c0-17.4-14.1-31.5-31.5-31.5s-31.5 14.1-31.5 31.5v105c0 17.5 14.1 31.5 31.5 31.5h105c17.4 0 31.5-14.1 31.5-31.5s-14.1-31.5-31.5-31.5h-73.5z m0 0" p-id="8548" fill="#409EFF"></path></svg>
            <span style="position: relative;left: 10px;top: -10px">最近历史操作</span>
          </el-divider>
          <el-timeline>
            <el-timeline-item placement="top"
              v-for="item in distributionInfo.distributionList" :key="item._id"
                              :timestamp="item.create_time | transformUtc"
            >
              <el-card style="padding: 10px">
                <span style="color: #67c13a;font-weight: bolder;font-size: 15px">业主{{item.user_id.name}}发起了物资申请</span><br>
                本次申请消耗了<span style="color: #409EFF;font-weight: bolder;margin: 10px">{{item.ration}}</span>配额
              </el-card>
            </el-timeline-item>
          </el-timeline>
        </el-card>
...
export default {
  ...
  methods:{
    ...
    // 物资申请步骤条下一项
    stepNext(){
      if (this.getMaterialStepIndex++ > 1) this.getMaterialStepIndex = 0;
    }
  },
  created() {
    this.getDistribution()
